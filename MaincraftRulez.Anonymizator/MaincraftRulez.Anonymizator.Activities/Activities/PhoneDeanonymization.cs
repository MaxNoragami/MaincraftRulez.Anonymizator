...
namespace MaincraftRulez.Anonymizator.Activities
{
    ...
    public class PhoneDeanonymization : ContinuableAsyncCodeActivity
    {
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            var task = ExecuteWithTimeout(context, anonymizedPhoneNumber, preserveCountryCode, preserveLeadingDigits, cancellationToken);
        ...
        private async Task<string> ExecuteWithTimeout(AsyncCodeActivityContext context, string anonymizedPhoneNumber, bool preserveCountryCode, int preserveLeadingDigits, CancellationToken cancellationToken = default)
        {
            try
            {
