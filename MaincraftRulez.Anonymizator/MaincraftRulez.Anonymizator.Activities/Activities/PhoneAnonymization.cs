...
{
    [LocalizedDisplayName(nameof(Resources.PhoneAnonymization_DisplayName))]
    [LocalizedDescription(nameof(Resources.PhoneAnonymization_Description))]
    public class PhoneAnonymization : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        [LocalizedDisplayName(nameof(Resources.PhoneAnonymization_OriginalPhoneNumber_DisplayName))]
        [LocalizedDescription(nameof(Resources.PhoneAnonymization_OriginalPhoneNumber_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        public InArgument<string> OriginalPhoneNumber { get; set; }

        [LocalizedDisplayName(nameof(Resources.PhoneAnonymization_AnonymizedPhoneNumber_DisplayName))]
        [LocalizedDescription(nameof(Resources.PhoneAnonymization_AnonymizedPhoneNumber_Description))]
        [LocalizedCategory(nameof(Resources.Output_Category))]
        public OutArgument<string> AnonymizedPhoneNumber { get; set; }

        [LocalizedDisplayName(nameof(Resources.PhoneAnonymization_PreserveCountryCode_DisplayName))]
        [LocalizedDescription(nameof(Resources.PhoneAnonymization_PreserveCountryCode_Description))]
        [LocalizedCategory(nameof(Resources.Input_Category))]
        ...
        {
            if (OriginalPhoneNumber == null) metadata.AddValidationError(string.Format(Resources.ValidationValue_Error, nameof(OriginalPhoneNumber)));
        ...
        protected override async Task<Action<AsyncCodeActivityContext>> ExecuteAsync(AsyncCodeActivityContext context, CancellationToken cancellationToken)
        {
            ...
            // Outputs
            return (ctx) => {
                AnonymizedPhoneNumber.Set(ctx, anonymizedPhoneNumber);
            };
        }
        ...
        private async Task<string> ExecuteWithTimeout(AsyncCodeActivityContext context, string originalPhoneNumber, bool preserveCountryCode, bool preserveAreaCode, int preserveLeadingDigits, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                string anonymizedPhoneNumber = phoneAnonymizer.Anonymize(originalPhoneNumber);

                return await Task.FromResult(anonymizedPhoneNumber);
            }
            catch (Exception ex)
            {
                // Add more informative error message to help troubleshoot
                throw new InvalidOperationException("Error anonymizing phone number. Make sure this activity is used within a UseAnonymization scope and the key is valid.", ex);
            }
        }
